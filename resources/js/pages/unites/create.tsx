...
export default function UnitesCreate() {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        post(UniteController.store.url());
    };
                ...
                <form onSubmit={handleSubmit}>
                    <Card className="border-primary/20 shadow-lg">
                        <CardHeader className="bg-primary/5 border-b mb-6">
                            <CardTitle>Configuration de l'unité</CardTitle>
                            <CardDescription>
                                Définissez une nouvelle unité de mesure pour quantifier vos produits.
                            </CardDescription>
                        </CardHeader>
                        <CardContent className="space-y-6">
                            <div className="space-y-2">
                                <Label htmlFor="nom" className="font-semibold text-foreground italic">
                                    Nom de l'unité (ex: Kg, Pièce, Litre)
                                </Label>
                                <Input
                                    id="nom"
                                    value={data.nom}
                            ...
                            <div className="space-y-2">
                                ...
                                <Textarea
                                    ...
                                    placeholder="Brève description de l'usage de cette unité..."
