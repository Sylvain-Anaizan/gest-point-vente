...
export default function EmployesEdit({
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        patch(EmployeController.update.url(employe.id));
    };

    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title={`Modifier ${employe.name}`} />
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-muted-foreground mt-1">
                            Mettez à jour les informations ou changez l'affectation de **{employe.name}**.
                        </p>
                    </div>
                </div>
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                        ...
                        <Card>
                            <CardHeader className="border-b">
                                ...
                                <CardDescription>
                                    Niveau d'accès et lieu de travail actuel.
                                </CardDescription>
                            </CardHeader>
