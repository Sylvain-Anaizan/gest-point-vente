...
export function AppHeader({ breadcrumbs = [] }: AppHeaderProps) {
    ...
    return (
        <>
            <div className="border-b border-sidebar-border/80 bg-white/80 backdrop-blur-md dark:bg-zinc-950/50">
                    ...
                    <div className="ml-auto flex items-center space-x-2">
                        ...
                        <DropdownMenu>
                            <DropdownMenuTrigger asChild>
                                <Button size="icon" className="h-9 w-9 rounded-md outline-none focus-visible:ring-2 focus-visible:ring-primary">
